...
> [!TIP]
> **无需配置本地开发环境，开箱即用！**
> 本项目已通过 GitHub Actions 自动构建出 Windows 与 macOS 的可执行客户端。请直接前往 [👉 GitHub Releases 1.6.6 下载页面](https://github.com/x554960766/wechatAutoRSSTool/releases/tag/v1.6.6) 下载最新版本。
...
- **视频号上传服务器功能（1.6.6 恢复与加固）**：支持在新作品抓取完成后自动进行视频下载 -> 本地解密 -> 腾讯云 COS 存储 -> 组包 POST 推送给指定服务器，并提供可视化的详细上传日志查看。
